#python3.10
""" Dataloader for droid dataset
NOTE: This script is
    borrowed from https://github.com/droid-dataset/droid_policy_learning/blob/master/examples/droid_dataloader.py
...
from robomimic.robomimic.utils.rlds_utils import droid_dataset_transform, robomimic_transform, TorchRLDSDataset

from octo.octo.data.dataset import make_dataset_from_rlds, make_interleaved_dataset
from octo.octo.data.utils.data_utils import combine_dataset_statistics
from octo.octo.utils.spec import ModuleSpec

tf.config.set_visible_devices([], "GPU")

# ------------------------------ Get Dataset Information ------------------------------
DATA_PATH = "/data1/home/xyx/"              # UPDATE WITH PATH TO RLDS DATASETS
...
filter_functions = [
    [
        ModuleSpec.create(
            "robomimic.robomimic.utils.rlds_utils:filter_success"
        )
